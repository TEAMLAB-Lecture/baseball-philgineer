...
def get_strikes_or_ball(user_input_number, random_number):
    ...
    input_str = str(user_input_number)
    rand_str = str(random_number)

    strike, ball = 0, 0
    for i in range(3):
        if input_str[i] == rand_str[i]:
            strike += 1
        elif input_str[i] in rand_str:
            ball += 1
    # ==================================
    return [strike, ball]
...
def is_yes(one_more_input):
    ...
    result = one_more_input.upper() in ["Y", "YES"]
    # ==================================
    return result
...
def is_no(one_more_input):
    ...
    result = one_more_input.upper() in ["N", "NO"]
    # ==================================
    return result
